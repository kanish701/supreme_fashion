...
function App() {
    ...
    return (
        <div className="min-h-screen bg-white text-gray-900" id="top"> {/* Added id="top" for scrolling */}

            {/* Navigation - Made static */}
            <nav className="w-full bg-white shadow-md border-b border-slate-100">
                    ...
                    <div className="text-left">
                        ...
                        <span className="uppercase text-sm tracking-[0.3em] font-medium text-slate-600 block mb-3">
                          ...
                          <span className="inline-block align-middle ml-2">
                            <button
                              className="bg-slate-600 text-white px-3 py-1 rounded-full text-xs font-semibold shadow hover:bg-slate-700 transition duration-200"
                              tabIndex={-1}
                        ...
                        {/* Description - Enhanced max-w for better line length */}
            ...
            {/* Our Philosophy Section - Reduced Vertical Space */}
            <section id="about" className="py-16 lg:py-24 bg-gray-700 text-white">
              <div className="max-w-7xl mx-auto px-6">
            ...
            <section id="showcase" className="py-16 lg:py-24 bg-gray-50">
              <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8">
                        ...
                        <div className="group relative overflow-hidden rounded-xl shadow-lg transition-shadow duration-300 hover:shadow-2xl">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-gray-900/50 to-transparent p-6 flex flex-col justify-end">
                                ...
                                <p className="text-white text-sm font-medium opacity-80">KNIT ESSENTIALS</p>
                            </div>
                        </div>
                        ...
                        <div className="group relative overflow-hidden rounded-xl shadow-lg transition-shadow duration-300 hover:shadow-2xl">
                            ...
                            {/* Overlay and Text */}
                            <div className="absolute inset-0 bg-gradient-to-t from-gray-900/50 to-transparent p-6 flex flex-col justify-end">
                                <h3 className="text-xl font-bold text-white uppercase tracking-wider transition-opacity duration-00 group-hover:opacity-100">COMFORT</h3>
                                <p className="text-white text-sm font-medium opacity-80">NIGHTS</p>
                            </div>
                        </div>
                        ...
                        <div className="group relative overflow-hidden rounded-xl shadow-lg transition-shadow duration-300 hover:shadow-2xl">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-gray-900/50 to-transparent p-6 flex flex-col justify-end">
                                ...
                                <p className="text-white text-sm font-medium opacity-80">SLEEPS</p>
                            </div>
                        </div>
                        ...
                        <div className="group relative overflow-hidden rounded-xl shadow-lg transition-shadow duration-300 hover:shadow-2xl">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-gray-900/50 to-transparent p-6 flex flex-col justify-end">
                                ...
                                <p className="text-white text-sm font-medium opacity-80">DAYS</p>
                            </div>
                        </div>

                        {/* 10. Outerwear Card (Index 9 in original code) */}
                        <div className="group relative overflow-hidden rounded-xl shadow-lg transition-shadow duration-300 hover:shadow-2xl">
                            <img
                                src="https://media.babyshopstores.com/i/babyshop/SBT001A25MULTICOLORMULTISHADE-SBT001A25-SS26230925_01-2100.jpg?$prodimg-d-sqr-5-2x$&$quality-retina$&fmt=auto&sm=c"
                                alt="kidswear Collection"
                                className="object-cover w-full h-[350px] md:h-[450px] transition-transform duration-500 group-hover:scale-105"
                            />
                            {/* Overlay and Text */}
                            <div className="absolute inset-0 bg-gradient-to-t from-gray-900/50 to-transparent p-6 flex flex-col justify-end">
                                <h3 className="text-xl font-bold text-white uppercase tracking-wider transition-opacity duration-300 group-hover:opacity-100">KIDS</h3>
                                <p className="text-white text-sm font-medium opacity-80">CASUALS</p>
                            </div>
                        </div>
